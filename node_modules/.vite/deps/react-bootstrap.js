...
import {
  ...
  useNavItem,
  usePrevious
} from "./chunk-4GDRIIM4.js";
import {
  Row_default
} from "./chunk-26WJPVI2.js";
import {
...
function useTimeout() {
  ...
  var handleRef = (0, import_react11.useRef)();
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react13.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react16.useContext)(DropdownContext_default);
...
function Dropdown({
  ...
  const context4 = (0, import_react20.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var FormGroup = React43.forwardRef(({
  controlId,
  as: Component2 = "div",
  ...props
}, ref) => {
...
var FormLabel = React44.forwardRef(({
  as: Component2 = "label",
  bsPrefix,
  column,
  visuallyHidden,
...
var FormRange = React45.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React46.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
...
var FormText = React47.forwardRef(
  ({
    bsPrefix,
    className,
    as: Component2 = "small",
...
var Switch = React48.forwardRef((props, ref) => (0, import_jsx_runtime49.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React49.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var Container = React51.forwardRef(({
  bsPrefix,
  fluid,
  as: Component2 = "div",
  className,
...
Image.defaultProps = defaultProps17;
...
var Modal = (0, import_react35.forwardRef)((_ref, ref) => {
  ...
  if (Transition) {
    dialog = (0, import_jsx_runtime59.jsx)(Transition, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition3) {
      backdropElement = (0, import_jsx_runtime59.jsx)(BackdropTransition3, {
        appear: true,
        in: !!show,
  ...
  return (0, import_jsx_runtime59.jsx)(import_jsx_runtime60.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime61.jsxs)(import_jsx_runtime60.Fragment, {
...
var AbstractModalHeader = React60.forwardRef(({
  ...
  const context4 = (0, import_react36.useContext)(ModalContext_default);
...
var Modal2 = React62.forwardRef(({
  ...
  const renderBackdrop = (0, import_react37.useCallback)((backdropProps) => (0, import_jsx_runtime66.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime66.jsx)("div", {
    ...
    className: (0, import_classnames45.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`),
...
var NavbarCollapse = React64.forwardRef(({
  ...
  return (0, import_jsx_runtime68.jsx)(Collapse_default, {
...
var NavbarToggle = React65.forwardRef(({
  ...
  return (0, import_jsx_runtime69.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime69.jsx)("span", {
...
var OffcanvasToggling = React66.forwardRef(({
  bsPrefix,
  className,
  children,
  ...props
  ...
  return (0, import_jsx_runtime70.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React66.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React67.forwardRef(({
  bsPrefix,
  className,
  ...props
}, ref) => {
...
var Offcanvas = React68.forwardRef(({
  ...
  const renderBackdrop = (0, import_react42.useCallback)((backdropProps) => (0, import_jsx_runtime72.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames50.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime72.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames50.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
...
var NavbarOffcanvas = React69.forwardRef((props, ref) => {
...
var Navbar = React70.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime76.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var Overlay = React72.forwardRef((props, outerRef) => {
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime79.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
var Popover = React74.forwardRef(({
  bsPrefix,
  placement,
  className,
  style,
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React77.forwardRef(({
    children,
    ...props
...
var SplitButton = React84.forwardRef(({
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime95.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime94.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime94.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
...
Tabs.defaultProps = defaultProps34;
...
var ToastFade = React88.forwardRef((props, ref) => (0, import_jsx_runtime100.jsx)(Fade_default, {
  ...props,
  ref,
...
ToastHeader.defaultProps = defaultProps35;
...
var Toast = React91.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime103.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime103.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime103.jsx)(Transition, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
...
var ToastContainer = React92.forwardRef(({
  ...
  return (0, import_jsx_runtime104.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames65.default)(bsPrefix, position && [containerPosition ? `position-${containerPosition}` : null, positionClasses[position]], className)
  });
});
...
var ToggleButton = React93.forwardRef(({
  ...
  return (0, import_jsx_runtime107.jsxs)(import_jsx_runtime106.Fragment, {
    children: [(0, import_jsx_runtime105.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime105.jsx)(Button_default2, {
      ...props,
      ref,
...
var ToggleButtonGroup = React94.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime108.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    children: map(children, (child) => {
      const values = getValues();
