...
function useNavItem({
  ...
  const parentOnSelect = (0, import_react14.useContext)(SelectableContext_default);
  const navContext = (0, import_react14.useContext)(NavContext_default);
  const tabContext = (0, import_react14.useContext)(TabContext_default);
  let isActive = active;
  const props = {
    role
  };
...
function useForceUpdate() {
  var _useReducer = (0, import_react15.useReducer)(function(state) {
    return !state;
...
var Nav = React6.forwardRef((_ref, ref) => {
  ...
  const needsRefocusRef = (0, import_react16.useRef)(false);
  ...
  const listNode = (0, import_react16.useRef)(null);
...
//# sourceMappingURL=chunk-4GDRIIM4.js.map
